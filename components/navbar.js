              ...
              <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
                <Link href="/">
                  <span className="flex items-center space-x-2 text-2xl font-medium text-orange-500 dark:text-gray-100">
                    ...
                    <span className="text-center"><div className="font-bold">Suleat</div> <div className="text-xs">Super Food</div></span>
                  </span>
                </Link>
                ...
                {/* <Disclosure.Panel className="flex flex-wrap w-full my-5 lg:hidden">
                  <>
                    ...
                    <Link href="/projects" className="w-full px-4 py-2 -ml-4 text-gray-500 rounded-md dark:text-gray-300 hover:text-orange-500 focus:text-orange-500 focus:bg-orange-100 dark:focus:bg-gray-800 focus:outline-none">
                          Projects
                    </Link>
