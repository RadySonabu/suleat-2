    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12">
            <div class="col-span-2 md:col-span-4 xl:pr-8">
                <Image width="100" height="100" class="10-auto h-18" src="https://2023-lamba-bucket.s3.ap-southeast-1.amazonaws.com/Group+39.png" alt="" />

                <p class="text-base leading-relaxed text-gray-600 mt-7">Suleat, Super Food!</p>

                <a href="#" title="" class="inline-flex items-center justify-center px-6 py-4 font-semibold text-white transition-all duration-200 bg-orange-600 rounded-md hover:bg-orange-700 focus:bg-orange-700 mt-7">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        <path class-linecap="round" class-linejoin="round" class-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                    </svg>
                    Start Live Chat
                </a>
            </div>
