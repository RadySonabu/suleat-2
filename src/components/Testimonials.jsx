...
const testimonials = [
    {
        ...
        name: "Martin escobar",
        quote: "Our stores are a third place between work and home, a gathering place where everyone is welcome."
    },
    {
        avatar: "https://randomuser.me/api/portraits/men/46.jpg",
        name: "Simon andrew",
        quote: "Creating a culture of warmth and belonging, where everyone is treated with respect and dignity, is our highest priority."
    },
    {
        avatar: "https://randomuser.me/api/portraits/men/86.jpg",
        name: "Micheal worin",
        quote: "Every interaction is an opportunity to create a memorable experience that leaves a lasting impression."
    },
]
    ...
    <section className="relative py-14">
        <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
            <div className="max-w-xl sm:text-center md:mx-auto">
                ...
                Innovation and continuous improvement are key to staying ahead in a rapidly changing industry.
                </p>
            </div>
            <div className="mt-12">
