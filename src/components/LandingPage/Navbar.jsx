...
function Navbar() {
  return (
    <div className='flex  flex-1 w-ful'>
        <nav className="container flex items-center justify-between flex-wrap  p-4 mx-auto">
            <Link href="/">
            ...
            <div className="w-full mx-auto block flex-grow lg:flex lg:items-center lg:w-auto">
                <div>
